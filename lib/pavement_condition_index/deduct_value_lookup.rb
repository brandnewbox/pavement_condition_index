module PavementConditionIndex
  class DeductValueLookup
    ...
    def call(value)
      ...
      value = @pavement_type == :asphalt ? Math.log10(value) : value
      value = generate_polynomial(*coefficients).call(value)
      # NOTE: This is a strange limits thing, because we do not
      # know what to do when a distress density goes "out of bounds"
